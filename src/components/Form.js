...
export default function Form(props) {
    ...
    return (
        <div>
            ...
            <div className="mb-3">
                <textarea style={{ backgroundColor: props.mode === 'dark' ? '#212529' : 'white', color: props.mode === 'dark' ? 'white' : 'black' }} className="form-control" value={text} onChange={onChange} id="exampleFormControlTextarea1" rows="3" placeholder='Enter Text Here'></textarea>
            </div>
            ...
            <div>
                ...
                <h5 className={`text-${props.mode === 'light' ? 'dark' : 'light'}`}>{wordCount} Words and {text.length} characters</h5>
                {wordCounter()}
